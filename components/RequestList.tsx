...
function RequestCard({ request }: { request: UserSwapRequest }) {
  ...
  return (
    <div className={`flex items-center gap-4 bg-white border rounded-2xl px-4 py-3.5 hover:shadow-sm transition-all duration-200 ${
      isExpiringSoon ? 'border-red-100 bg-red-50/30' : 'border-slate-100'
    }`}>
