    ...
    <div className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10  flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-5xl lg:text-7xl font-poppins-black  text-slate-900 leading-tight mb-6">
            Swap your home. <br />
            <span className="text-emerald-600 font-poppins-black">Skip the agent.</span>
          </h1>
          <p className="text-xl font-poppins-regular text-slate-600 mb-10 max-w-2xl mx-auto lg:mx-0">
        ...
        <div className="flex-1 relative">
          <img
            src="https://picsum.photos/seed/tenant/800/600"
            alt="Beautiful Nigerian Home"
            className="rounded-3xl shadow-2xl border-8 border-white object-cover aspect-video lg:aspect-square"
          />
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-4">Post Your House</h3>
              <p className="text-slate-500 leading-relaxed">List the house you're leaving and the house you're looking for in any major Nigerian city.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="w-14 h-14 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center text-2xl mb-6 mx-auto">
                <Link2 size={28} />
              </div>
              <h3 className="text-xl font-bold mb-4">Chain Matching</h3>
              <p className="text-slate-500 leading-relaxed">Our algorithm finds 2-way, 3-way, or even 4-way swaps to get everyone into their dream home.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="w-14 h-14 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center text-2xl mb-6 mx-auto">
                <Handshake size={28} />
              ...
              <p className="text-slate-500 leading-relaxed">Get the phone numbers of potential swappers instantly. No agents, no middle-men.</p>
            </div>
          </div>
        </div>
      </div>
